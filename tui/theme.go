...
var themes = map[string]Theme{
	"default": {
		...
		PreviewLabelFg: lipgloss.Color("243"),
		PreviewValueFg: lipgloss.Color("252"),
	...
	"monokai": {
		...
		PreviewLabelFg: lipgloss.Color("242"),
		PreviewValueFg: lipgloss.Color("253"),
	...
	"dracula": {
		...
		PreviewLabelFg: lipgloss.Color("103"),
		PreviewValueFg: lipgloss.Color("253"),
	...
	"catppuccin": {
		...
		PreviewLabelFg: lipgloss.Color("245"),
